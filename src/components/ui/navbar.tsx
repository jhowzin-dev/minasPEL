...
export function Navbar() {
  return (
    ...
    <nav className="fixed top-0 left-0 w-full z-50 flex items-center justify-between px-8 py-4 bg-[var(--bg-white-20)] dark:bg-[var(--bg-black-30)] backdrop-blur-xl border-b border-white/7 isolate transform-gpu">
